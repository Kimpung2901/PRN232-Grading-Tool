...
public interface ISubmissionService
{
    ...
    Task<ServiceResult<IReadOnlyList<SubmissionGradeReport>>> GetReportsByExamAsync(int examId, CancellationToken cancellationToken);
    ...
    Task<ServiceResult<Submission>> RequeueAsync(int id, CancellationToken cancellationToken);
    Task<ServiceResult<int>> RequeueByExamAsync(int examId, CancellationToken cancellationToken);
